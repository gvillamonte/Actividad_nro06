...
if ($lang == "fr") {
    ...
    $ModalNotifyHelper = "Lasciare vuoto per disabilitare la notifica via email";
    ...
    $DeleteConfirm = "Questa azione è irreversibile! Sei sicuro di voler eliminare questo ordine?";
    $DeleteAllConfirm ="Questa azione è irreversibile! Sei sicuro di voler eliminare TUTTI i tuoi ordini?";
    ...
    $JSONVersion = "JSON";
    $HTMLVersion = "HTML";
    $Click4Details = "Ordine nel vecchio formato TOWeb (< 5.16). Clicca per visualizzare i dettagli.";
} else if ($lang == "es") {
    $Title = "Pedidos";
    $Periods = [
        7 => "1 semana",
    ...
    $ModalNotifyHelper = "Dejar en blanco para desactivar la notificación por correo electrónico";
    ...
    $DeleteConfirm = "¡Esta acción es irreversible! ¿Está seguro de que desea eliminar este pedido?";
    $DeleteAllConfirm = "¡Esta acción es irreversible! ¿Está seguro de que desea eliminar TODOS sus archivos de pedido?";
    ...
    $JSONVersion = "JSON";
    $HTMLVersion = "HTML";
    $Click4Details = "Pedido en el antiguo formato de TOWeb (< 5.16). Haga clic para ver detalles.";
} else if ($lang == "de") {
    $Title = "Bestellungen";
    $Periods = [
        7 => "1 Woche",
    ...
    $ModalNotifyHelper = "Lassen Sie dieses Feld leer, um die Benachrichtigung per E-Mail zu deaktivieren";
    ...
    $DeleteConfirm = "Diese Aktion kann nicht rückgängig gemacht werden! Sind Sie sicher, dass Sie diese Bestellung löschen möchten?";
    $DeleteAllConfirm = "Diese Aktion kann nicht rückgängig gemacht werden! Sind Sie sicher, dass Sie ALLE Ihre Bestellungsdateien löschen möchten?";
    ...
    $JSONVersion = "JSON";
    $HTMLVersion = "HTML";
    $Click4Details = "Bestellung im alten TOWeb-Format (< 5.16). Klicken Sie hier, um Details anzuzeigen.";
} else if ($lang == "pt") {
    $Title = "Comandos";
    $Periods = [
        7 => "1 semana",
    ...
    $ModalNotifyHelper = "Deixe este campo em branco para desativar a notificação por email";
    $ModalCloseBtn = "Cancelar";
    ...
    $DeleteConfirm = "Esta ação é irreversível! Tem certeza de que deseja excluir este comando?";
    $DeleteAllConfirm = "Esta ação é irreversível! Tem certeza de que deseja excluir TODOS os seus arquivos de comando?";
    ...
    $JSONVersion = "JSON";
    $HTMLVersion = "HTML";
    $Click4Details = "Comando no formato antigo do TOWeb (< 5.16). Clique para ver o detalhe.";
}
    ...
    if ($action == "setOrderState") {
        ...
        if ($newState != $currState) {
            ...
            if ($message != "" && $sendTo != "") {
				...
				SendPhpMail( $mail_account, $sendTo, 
                            sprintf(
                                $NotifySubject,
                                $oid,
